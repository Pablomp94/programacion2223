...
public class expresionesRegulares {
	...
	public static void main(String[] args) {
		...
		//ejemplol: devolvera false, ya que la cadena tiene mas caracteres
		System.out.println("ejemplol: " + cadena. matches ("Solo"));
		...
		// ejemplo5: devolvera true, S1 quitamos los caracteres delante de ? del STring original seguira devolviendo true
		...
		// ejemplolO: devolvera true, ya que, ademas del ejemplo anterior, indicamos que debe repetirse un valor numerico entre l y 10 veces
		System.out.println("ejemplolO: "+cadena2. matches ("[abc]+\\d{1,10}"));
	}
